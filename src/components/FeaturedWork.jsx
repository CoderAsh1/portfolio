...
const projects = [
    ...
    {
        title: 'PhoxHealth',
        subtitle: 'US Pharmaceutical Logistics System',
        description: 'Engineered a widely-adopted medicine delivery platform for the US market, revolutionizing last-mile pharmaceutical logistics.',
        icon: Activity,
        period: '2022 - Present',
        location: 'USA',
        achievements: [
